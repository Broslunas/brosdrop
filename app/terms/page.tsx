    ...
    return (
      <div className="bg-zinc-950 min-h-screen py-24 sm:py-32 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8 relative z-10">
          <div className="mx-auto max-w-3xl text-base leading-7 text-gray-300 bg-zinc-900/40 border border-white/5 rounded-3xl p-8 md:p-12 backdrop-blur-xl">
            <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl mb-10 text-center">Términos de Servicio</h1>
            
            <div className="space-y-8">
              <section>
                  <h2 className="text-xl font-bold text-white mb-4">1. Acuerdo de Términos</h2>
                  <p>
              ...
              <section>
                  <h2 className="text-xl font-bold text-white mb-4">2. Derechos de Propiedad Intelectual</h2>
                  <p>
              ...
              <section>
                  <h2 className="text-xl font-bold text-white mb-4">3. Representaciones del Usuario</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-white mb-4">4. Actividades Prohibidas</h2>
                  <p>
