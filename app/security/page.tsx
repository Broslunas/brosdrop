    ...
    return (
        <div className="bg-zinc-950 min-h-screen py-24 sm:py-32 relative overflow-hidden">
             ...
             <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                ...
                <div className="absolute bottom-[-10%] left-[-10%] w-[40rem] h-[40rem] bg-emerald-500/20 rounded-full blur-[128px] animate-pulse" style={{ animationDelay: '2s' }} />
            </div>

            <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
                <div className="mx-auto max-w-2xl lg:text-center mb-20">
                    <h2 className="text-base font-semibold leading-7 text-emerald-400">Seguridad Primero</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {securityFeatures.map((feature, i) => (
                        <motion.div
                            ...
                            className={`p-8 rounded-3xl border ${feature.border} ${feature.bg} backdrop-blur-sm relative overflow-hidden group`}
                        >
                ...
                {/* Compliance Badge Area */}
                 <div className="mt-24 text-center">
                    <p className="text-zinc-500 text-sm mb-8 uppercase tracking-widest font-semibold">Comprometidos con tu privacidad</p>
                    <div className="flex flex-wrap justify-center gap-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
                        {/* Mock logos for compliance/tech stack */}
                        <div className="flex items-center gap-2 px-4 py-2 border border-white/10 rounded-lg bg-white/5">
